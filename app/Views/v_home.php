          ...
          <div class="about-img position-relative overflow-hidden p-5 pe-0">
            ...
            <?php if (!empty($profile) && isset($profile[0])): ?>
              ...
              <?php if (isset($profile[0]['profile_foto'])): ?>
                <img src="<?= base_url('img/profile/' . $profile[0]['profile_foto']) ?>" alt="Profile Foto" width="300"
                  height="300">
              <?php else: ?>
          ...
          <div class="row g-4">
            <?php foreach ($produk as $key => $value) { ?>
              ...
              <!-- <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="product-item">
                  <div class="position-relative bg-light overflow-hidden">
                    <img class="img-fluid w-100" src="img/cesin.png" alt="" />
                    <div class="bg-secondary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                      New
                    </div>
                  </div>
                  <div class="text-center p-4">
                    <a class="d-block h5 mb-2" href="">Fresh Cesin</a>
                    <span class="text-primary me-1">Rp. 12.000 / Kg</span>
                    <span class="text-body text-decoration-line-through">Rp. 15.000 / Kg</span>
                  </div>
                  <div class="d-flex border-top">
                    <small class="w-50 text-center border-end py-2">
                      <p class="text-body" href="">
                    ...
                    <small class="w-50 text-center py-2">
                      <a class="text-body" href=""><i class="fa fa-shopping-bag text-primary me-2"></i>Kontak Kami</a>
                    </small>
                  </div>
                </div>
              </div> -->
    ...
    <div class="container">
      ...
      <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
        ...
        <!-- <div class="testimonial-item position-relative bg-white p-5 mt-4">
          <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
          <p class="mb-4">
            KWTBugel menyediakan hidroponik terbaik. Tanaman sehat, enak, dan
            berlimpah. Layanan pelanggan responsif. Puas dengan pembelian,
            pasti akan kembali!
          </p>
          <div class="d-flex align-items-center">
            <img class="flex-shrink-0 rounded-circle" src="img/testimonial-2.jpg" alt="" />
            <div class="ms-3">
              <h5 class="mb-1">Andi Kusuma</h5>
              <span> Pelanggan KWTBugel</span>
            </div>
          </div>
        </div>
        <div class="testimonial-item position-relative bg-white p-5 mt-4">
          <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
          <p class="mb-4">
            Belanja di KWTBugel memuaskan. Produk hidroponik berkualitas
            tinggi dan kesegaran terjamin. Ulasan positif pelanggan lain benar
            adanya. Terima kasih KWTBugel!
          </p>
          <div class="d-flex align-items-center">
            <img class="flex-shrink-0 rounded-circle" src="img/testimonial-3.jpg" alt="" />
            <div class="ms-3">
              <h5 class="mb-1">Adi Nugroho</h5>
              <span>Petani Organik</span>
            </div>
          </div>
        </div>
        <div class="testimonial-item position-relative bg-white p-5 mt-4">
          <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
          <p class="mb-4">
            KWTBugel luar biasa! Tanaman hidroponik mereka segar, bebas
            pestisida, dan lezat. Layanan pelanggan ramah dan membantu.
            Rekomendasi tinggi!
          </p>
          <div class="d-flex align-items-center">
            <img class="flex-shrink-0 rounded-circle" src="img/testimonial-4.jpg" alt="" />
            <div class="ms-3">
              <h5 class="mb-1">Rina Fitriani</h5>
              <span>Ahli Nutrisi dan Kesehatan</span>
            </div>
          </div>
        </div> -->
      </div>
